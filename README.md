...
|:---:	|:---:	|:---:	|:---:	|:---:	|:---:	|
| **디지털경제와 데이터사이언스이해<br>(`구 E정보시스템`)** 	| 없음 	| 대학<br>1-2 	| 파이썬 사용법<br>데이터 핸들링 	| 1~2학년 및 학과 무관 	| `23년`<br>예정 	|
| **비즈니스애널리틱스<br>(`구 E데이터베이스`)** 	| 디지털경제와 데이터사이언스이해 	| 대학<br>3-1 	| 문제 해결을 위한 데이터분석 프로세스 이해<br>통계 및 기계학습 활용 문제 해결 고도화 	| 선수과목 이수한 학년/학과 무관 	| `23년`<br>예정 	|
| **인공지능활용의사결정<br>(`구 빅데이터`)** 	| 비즈니스애널리틱스 	| 대학<br>4-1 	| 비즈니스 사례기반 문제 해결<br>인공지능 알고리즘으로 성능 향상 	| 선수과목 이수한 학년/학과 무관 	| `23년`<br>예정 	|
| **캡스톤디자인** 	| 미정 	| 미정 	| 실제 현업 문제 해결 연구 및 전략 기획 	| 미정 	| `23년`<br>예정 	|
| **비즈니스혁신을위한데이터사이언스응용** 	| 없음 	| 대학원<br>1학기 	| 파이썬 사용법<br>데이터 핸들링 및 시각화 	| 학년 및 학과 무관 	| `22년`<br>신설 	|
| **인공지능활용디지털경제플랫폼연구** 	| 비즈니스혁신을위한데이터사이언스응용 	| 대학원<br>2학기 	| 문제 해결을 위한 데이터분석 프로세스 이해<br>통계 및 기계학습 활용 문제 해결 고도화 	| 선수과목 이수한 학년/학과 무관 	| `22년`<br>신설 	|
