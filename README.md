## Curriculum-Guide
> **"데이터 및 디지털 기반 사회적경제 `비즈니스 전략과 방법론 변화`에 따른 `인재 수요 대응`을 위한 `비전공자들의 커리큘럼 개선`"**
...
| **과정** | **과목명** | **선수과목 및 추천대상** | **내용** |
|:---:|:---:|:---:|:---:|
| 대학<br>1-2 | **비즈니스데이터사이언스이해**  | 없음 <br> (학년/학과 무관) | (1) 데이터사이언스 이해 <br> (2) 파이썬 사용법 <br> (3) 데이터 핸들링  |
| 대학<br>3-1 | **디지털비즈니스애널리틱스**  | 비즈니스데이터사이언스이해 <br> (선수과목 이수, 학년/학과 무관) | (1) 문제 해결을 위한 데이터분석 프로세스 이해 <br> (2) 통계 및 기계학습 활용 실제 비즈니스 문제 해결 |
| 대학<br>4-1 | **인공지능기반의사결정**  | 디지털비즈니스애널리틱스 <br> (선수과목 이수, 학년/학과 무관) | (1) 기계학습 및 인공지능 알고리즘 이해 <br> (2) 비즈니스 사례기반 문제 해결과 전략 기획 |
| 대학원1 | **비즈니스혁신을위한데이터사이언스응용**  | 없음 <br> (학년/학과 무관) | (1) 데이터사이언스 이해 <br> (2) 파이썬 사용법 <br> (3) 데이터 핸들링 <br>   (4) 데이터 시각화 |
| 대학원2 |  **인공지능활용디지털경제플랫폼연구**  | 비즈니스혁신을위한데이터사이언스응용 <br> (선수과목 이수, 학년/학과 무관) | (1) 문제 해결을 위한 데이터분석 프로세스 이해 <br> (2) 통계 및 기계학습 활용 문제 해결 고도화   <br> (3) 비즈니스 사례기반 문제 해결  |
